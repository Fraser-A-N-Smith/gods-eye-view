...
const CABLE_GLOBE_STACK_IDS = Object.freeze(
  new Set([
    'bing-aerial', 'bing-labels', 'osm',
    'gibs-truecolor', 'gibs-geocolor',
    'sentinel2-truecolor', 'sentinel1-sar',
  ]),
);
 ...
 * bing stacks, osm, and the GIBS imagery stacks) renders imagery on the shown
 * globe, so only the terrain pass applies.
