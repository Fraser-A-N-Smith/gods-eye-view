...
| **NOAA Space Weather Prediction Center** | OVATION aurora forecast grid, planetary K-index, and the NOAA radio-blackout (R) scale (space-weather panel) | US public domain | "NOAA / NWS Space Weather Prediction Center" |
